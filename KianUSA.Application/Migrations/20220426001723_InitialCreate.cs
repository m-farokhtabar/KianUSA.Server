        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Security = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Fob = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FobSac = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WH = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Cube = table.Column<double>(type: "float", nullable: true),
                    ...
                    BoxD = table.Column<double>(type: "float", nullable: true),
                    BoxH = table.Column<double>(type: "float", nullable: true),
                    Security = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WHQTY = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Order = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
